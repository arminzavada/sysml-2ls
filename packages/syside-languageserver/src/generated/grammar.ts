...
export const KerMLGrammar = (): Grammar => loadedKerMLGrammar ?? (loadedKerMLGrammar = loadGrammarFromJson(`{
  ...
  "rules": [
    ...
    },
    {
      ...
      "fragment": false,
      "parameters": [],
      "$comment": "/* Unioning, Intersecting and Differencing */"
    },
    {
      "$type": "ParserRule",
      "name": "Intersecting",
    ...
    },
    {
      ...
      "fragment": false,
      "parameters": [],
      "$comment": "/* Classifier Conjugation */"
    },
    {
      "$type": "ParserRule",
      "fragment": true,
