...
export interface Classifier extends Type {
    readonly $type: 'ActionDefinition' | 'AllocationDefinition' | 'AnalysisCaseDefinition' | 'Association' | 'AssociationStructure' | 'AttributeDefinition' | 'Behavior' | 'CalculationDefinition' | 'CaseDefinition' | 'Class' | 'Classifier' | 'ConcernDefinition' | 'ConjugatedPortDefinition' | 'ConnectionDefinition' | 'ConstraintDefinition' | 'DataType' | 'Definition' | 'EnumerationDefinition' | 'FlowDefinition' | 'Interaction' | 'InterfaceDefinition' | 'ItemDefinition' | 'LifeClass' | 'Metaclass' | 'MetadataDefinition' | 'OccurrenceDefinition' | 'PartDefinition' | 'PortDefinition' | 'Predicate' | 'RenderingDefinition' | 'RequirementDefinition' | 'StateDefinition' | 'Structure' | 'SysMLFunction' | 'UseCaseDefinition' | 'VerificationCaseDefinition' | 'ViewDefinition' | 'ViewpointDefinition';
}
...
export type ConjugatesToken = 'conjugates' | '~';

export function isConjugatesToken(item: unknown): item is ConjugatesToken {
    return item === '~' || item === 'conjugates';
}
...
export interface Connector extends Feature, Relationship {
    readonly $type: 'AllocationUsage' | 'BindingConnector' | 'BindingConnectorAsUsage' | 'ConnectionUsage' | 'Connector' | 'ConnectorAsUsage' | 'FlowUsage' | 'InterfaceUsage' | 'ItemFlow' | 'Succession' | 'SuccessionAsUsage' | 'SuccessionFlowUsage' | 'SuccessionItemFlow';
...
export interface ConstructorExpression extends InvocationExpression {
...
export interface FlowUsage extends ActionUsage, ConnectorAsUsage, ItemFlow {
...
export type InlineExpression = CollectExpression | ConstructorExpression | FeatureChainExpression | FeatureReferenceExpression | IndexExpression | InvocationExpression | LiteralExpression | MetadataAccessExpression | NullExpression | OperatorExpression | SelectExpression;
...
export interface InvocationExpression extends Expression {
    readonly $type: 'CollectExpression' | 'ConstructorExpression' | 'FeatureChainExpression' | 'IndexExpression' | 'InvocationExpression' | 'OperatorExpression' | 'SelectExpression' | 'TriggerInvocationExpression';
...
export interface ItemFlow extends Connector, Step {
    readonly $type: 'FlowUsage' | 'ItemFlow' | 'SuccessionFlowUsage' | 'SuccessionItemFlow';
...
export interface Succession extends Connector {
    readonly $type: 'Succession' | 'SuccessionAsUsage' | 'SuccessionFlowUsage' | 'SuccessionItemFlow';
}
...
export interface SuccessionFlowUsage extends FlowUsage, SuccessionItemFlow {
...
export interface SuccessionItemFlow extends ItemFlow, Succession {
    readonly $type: 'SuccessionFlowUsage' | 'SuccessionItemFlow';
}
...
export type TypedByToken = string;

export function isTypedByToken(item: unknown): item is TypedByToken {
    return typeof item === 'string';
}
    ...
    override readonly types = {
        AcceptActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: AcceptActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        AllocationUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: AllocationUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        AnalysisCaseUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: AnalysisCaseUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        AssertConstraintUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: AssertConstraintUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        AssignmentActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: AssignmentActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        AttributeUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: AttributeUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        BindingConnectorAsUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: BindingConnectorAsUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        CalculationUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: CalculationUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        ClassifierReference: {
            ...
            properties: {
                isGlobal: {
                    name: ClassifierReference.isGlobal,
                    defaultValue: false
                },
                parts: {
        ...
        CollectExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: CollectExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        ConjugatedPortReference: {
            ...
            properties: {
                isGlobal: {
                    name: ConjugatedPortReference.isGlobal,
                    defaultValue: false
                },
                parts: {
        ...
        ConnectionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: ConnectionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        ConnectorAsUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: ConnectorAsUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        ConstraintUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: ConstraintUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        ConstructorExpression: {
            ...
            properties: {
                children: {
                    name: ConstructorExpression.children,
                    defaultValue: []
                },
                crossingFeature: {
                    name: ConstructorExpression.crossingFeature
                },
                declaredName: {
                    name: ConstructorExpression.declaredName
                },
                declaredShortName: {
                    name: ConstructorExpression.declaredShortName
                },
                direction: {
                    name: ConstructorExpression.direction
                },
                heritage: {
                    name: ConstructorExpression.heritage,
                    defaultValue: []
                },
                isAbstract: {
                ...
                isDerived: {
                    name: ConstructorExpression.isDerived
                },
                isEnd: {
                    name: ConstructorExpression.isEnd
                },
                isNonunique: {
                    name: ConstructorExpression.isNonunique,
                    defaultValue: false
                },
                isOrdered: {
                    name: ConstructorExpression.isOrdered,
                    defaultValue: false
                },
                isPortion: {
                    name: ConstructorExpression.isPortion
                },
                isSufficient: {
                    name: ConstructorExpression.isSufficient,
                    defaultValue: false
                },
                isVariable: {
                    name: ConstructorExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
                    name: ConstructorExpression.multiplicity
                },
                operands: {
                    name: ConstructorExpression.operands,
                    defaultValue: []
                },
                prefixes: {
                    name: ConstructorExpression.prefixes,
                    defaultValue: []
                },
                result: {
                    name: ConstructorExpression.result
                },
                typeRelationships: {
                    name: ConstructorExpression.typeRelationships,
                    defaultValue: []
                },
                value: {
                    name: ConstructorExpression.value
                },
                write: {
                    name: ConstructorExpression.write
                }
            },
        ...
        ElementReference: {
            ...
            properties: {
                isGlobal: {
                    name: ElementReference.isGlobal,
                    defaultValue: false
                },
                parts: {
        ...
        EnumerationUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: EnumerationUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        EventOccurrenceUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: EventOccurrenceUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        ExhibitStateUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: ExhibitStateUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        FeatureChainExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: FeatureChainExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        FeatureReference: {
            ...
            properties: {
                isGlobal: {
                    name: FeatureReference.isGlobal,
                    defaultValue: false
                },
                parts: {
        ...
        FeatureReferenceExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: FeatureReferenceExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        FlowDefinition: {
            ...
            properties: {
                ...
                elements: {
                    name: FlowDefinition.elements,
                    defaultValue: []
                },
                heritage: {
                    name: FlowDefinition.heritage,
                    defaultValue: []
                },
                isAbstract: {
                ...
                isSufficient: {
                    name: FlowDefinition.isSufficient,
                    defaultValue: false
                },
                isVariation: {
                ...
                multiplicity: {
                    name: FlowDefinition.multiplicity
                },
                prefixes: {
                    name: FlowDefinition.prefixes,
                    defaultValue: []
                },
                source: {
                    name: FlowDefinition.source
                },
                sourceChain: {
                    name: FlowDefinition.sourceChain
                },
                sourceRef: {
                    name: FlowDefinition.sourceRef
                },
                target: {
                    name: FlowDefinition.target
                },
                targetChain: {
                    name: FlowDefinition.targetChain
                },
                targetRef: {
                    name: FlowDefinition.targetRef
                },
                typeRelationships: {
                    name: FlowDefinition.typeRelationships,
                    defaultValue: []
                },
                visibility: {
                    name: FlowDefinition.visibility
                }
            },
        ...
        FlowUsage: {
            ...
            properties: {
                children: {
                    name: FlowUsage.children,
                    defaultValue: []
                },
                crossingFeature: {
                    name: FlowUsage.crossingFeature
                },
                declaredName: {
                ...
                messages: {
                    name: FlowUsage.messages,
                    defaultValue: []
                },
                multiplicity: {
                    name: FlowUsage.multiplicity
                },
                portionKind: {
                    name: FlowUsage.portionKind
                },
                prefixes: {
                    name: FlowUsage.prefixes,
                    defaultValue: []
                },
                source: {
                    name: FlowUsage.source
                },
                sourceChain: {
                    name: FlowUsage.sourceChain
                },
                sourceRef: {
                    name: FlowUsage.sourceRef
                },
                target: {
                    name: FlowUsage.target
                },
                targetChain: {
                    name: FlowUsage.targetChain
                },
                targetRef: {
                    name: FlowUsage.targetRef
                },
                typeRelationships: {
                    name: FlowUsage.typeRelationships,
                    defaultValue: []
                },
                value: {
                    name: FlowUsage.value
                },
                visibility: {
                    name: FlowUsage.visibility
                },
                write: {
                    name: FlowUsage.write
                }
            },
        ...
        ForLoopActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: ForLoopActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        IncludeUseCaseUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: IncludeUseCaseUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        IndexExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: IndexExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        InterfaceUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: InterfaceUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        InvocationExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: InvocationExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        LiteralBoolean: {
            ...
            properties: {
                ...
                isVariable: {
                    name: LiteralBoolean.isVariable,
                    defaultValue: false
                },
                literal: {
        ...
        LiteralExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: LiteralExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        LiteralInfinity: {
            ...
            properties: {
                ...
                isVariable: {
                    name: LiteralInfinity.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        LoopActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: LoopActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        MembershipReference: {
            ...
            properties: {
                isGlobal: {
                    name: MembershipReference.isGlobal,
                    defaultValue: false
                },
                parts: {
        ...
        MetaclassReference: {
            ...
            properties: {
                isGlobal: {
                    name: MetaclassReference.isGlobal,
                    defaultValue: false
                },
                parts: {
        ...
        MetadataAccessExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: MetadataAccessExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        MetadataFeature: {
            ...
            properties: {
                ...
                isVariable: {
                    name: MetadataFeature.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        MultiplicityRange: {
            ...
            properties: {
                ...
                isVariable: {
                    name: MultiplicityRange.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        NamespaceReference: {
            ...
            properties: {
                isGlobal: {
                    name: NamespaceReference.isGlobal,
                    defaultValue: false
                },
                parts: {
        ...
        NullExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: NullExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        OccurrenceUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: OccurrenceUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        OperatorExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: OperatorExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        PerformActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: PerformActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        ReferenceUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: ReferenceUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        RenderingUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: RenderingUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        RequirementUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: RequirementUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        SatisfyRequirementUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: SatisfyRequirementUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        SelectExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: SelectExpression.isVariable,
                    defaultValue: false
                },
                multiplicity: {
        ...
        SendActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: SendActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        SuccessionAsUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: SuccessionAsUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        SuccessionFlowUsage: {
            ...
            properties: {
                children: {
                    name: SuccessionFlowUsage.children,
                    defaultValue: []
                },
                crossingFeature: {
                    name: SuccessionFlowUsage.crossingFeature
                },
                declaredName: {
                ...
                elements: {
                    name: SuccessionFlowUsage.elements,
                    defaultValue: []
                },
                ends: {
                    name: SuccessionFlowUsage.ends,
                    defaultValue: []
                },
                heritage: {
                    name: SuccessionFlowUsage.heritage,
                    defaultValue: []
                },
                isAbstract: {
                ...
                isPortion: {
                    name: SuccessionFlowUsage.isPortion
                },
                isReference: {
                ...
                isVariable: {
                    name: SuccessionFlowUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
                ...
                item: {
                    name: SuccessionFlowUsage.item
                },
                messages: {
                    name: SuccessionFlowUsage.messages,
                    defaultValue: []
                },
                multiplicity: {
                    name: SuccessionFlowUsage.multiplicity
                },
                portionKind: {
                    name: SuccessionFlowUsage.portionKind
                },
                prefixes: {
                    name: SuccessionFlowUsage.prefixes,
                    defaultValue: []
                },
                source: {
                    name: SuccessionFlowUsage.source
                },
                sourceChain: {
                    name: SuccessionFlowUsage.sourceChain
                },
                sourceRef: {
                    name: SuccessionFlowUsage.sourceRef
                },
                target: {
                    name: SuccessionFlowUsage.target
                },
                targetChain: {
                    name: SuccessionFlowUsage.targetChain
                },
                targetRef: {
                    name: SuccessionFlowUsage.targetRef
                },
                typeRelationships: {
                    name: SuccessionFlowUsage.typeRelationships,
                    defaultValue: []
                },
                value: {
                    name: SuccessionFlowUsage.value
                },
                visibility: {
                    name: SuccessionFlowUsage.visibility
                },
                write: {
                    name: SuccessionFlowUsage.write
                }
            },
            superTypes: [FlowUsage.$type, SuccessionItemFlow.$type]
        },
        SuccessionItemFlow: {
            ...
            properties: {
                ...
                isVariable: {
                    name: SuccessionItemFlow.isVariable,
                    defaultValue: false
                },
                item: {
        ...
        TerminateActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: TerminateActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        TransitionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: TransitionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        TriggerInvocationExpression: {
            ...
            properties: {
                ...
                isVariable: {
                    name: TriggerInvocationExpression.isVariable,
                    defaultValue: false
                },
                kind: {
        ...
        VerificationCaseUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: VerificationCaseUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        ViewpointUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: ViewpointUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
        ...
        WhileLoopActionUsage: {
            ...
            properties: {
                ...
                isVariable: {
                    name: WhileLoopActionUsage.isVariable,
                    defaultValue: false
                },
                isVariation: {
