...
export function isName(item: unknown): item is Name {
    return (
        typeof item === "string" &&
        (/[_a-zA-Z][\w_\d]*/.test(item) || /'(\\['"bftnr\\]|[^'\\])*'/.test(item))
    );
}
...
export function isRequirementConstraintMembership(
    item: unknown
): item is RequirementConstraintMembership {
...
export function isSuccessionFlowConnectionUsage(
    item: unknown
): item is SuccessionFlowConnectionUsage {
...
export function isRequirementVerificationMembership(
    item: unknown
): item is RequirementVerificationMembership {
    ...
    protected override computeIsSubtype(subtype: string, supertype: string): boolean {
        switch (subtype) {
            ...
            case ActionDefinition: {
                return (
                    this.isSubtype(Behavior, supertype) ||
                    this.isSubtype(OccurrenceDefinition, supertype)
                );
            }
            case ActionUsage: {
                return (
                    this.isSubtype(OccurrenceUsage, supertype) || this.isSubtype(Step, supertype)
                );
            }
            ...
            case Membership: {
                return (
                    this.isSubtype(NonOwnerType, supertype) ||
                    this.isSubtype(Relationship, supertype)
                );
            }
            case AssertConstraintUsage: {
                return (
                    this.isSubtype(ConstraintUsage, supertype) ||
                    this.isSubtype(Invariant, supertype)
                );
            }
            case Association: {
                return (
                    this.isSubtype(Classifier, supertype) || this.isSubtype(Relationship, supertype)
                );
            }
            case AssociationStructure: {
                return (
                    this.isSubtype(Association, supertype) || this.isSubtype(Structure, supertype)
                );
            }
            ...
            case BindingConnectorAsUsage: {
                return (
                    this.isSubtype(BindingConnector, supertype) ||
                    this.isSubtype(ConnectorAsUsage, supertype)
                );
            }
            ...
            case CalculationDefinition: {
                return (
                    this.isSubtype(ActionDefinition, supertype) ||
                    this.isSubtype(SysMLFunction, supertype)
                );
            }
            case CalculationUsage: {
                return (
                    this.isSubtype(ActionUsage, supertype) || this.isSubtype(Expression, supertype)
                );
            }
            case CaseDefinition: {
            ...
            case SelectExpression: {
                return (
                    this.isSubtype(InlineExpression, supertype) ||
                    this.isSubtype(OperatorExpression, supertype)
                );
            }
            case Comment:
            ...
            case ConnectionDefinition: {
                return (
                    this.isSubtype(AssociationStructure, supertype) ||
                    this.isSubtype(PartDefinition, supertype)
                );
            }
            case ConnectionUsage: {
                return (
                    this.isSubtype(ConnectorAsUsage, supertype) ||
                    this.isSubtype(PartUsage, supertype)
                );
            }
            case Connector: {
                return (
                    this.isSubtype(Feature, supertype) || this.isSubtype(Relationship, supertype)
                );
            }
            ...
            case ConstraintDefinition: {
                return (
                    this.isSubtype(OccurrenceDefinition, supertype) ||
                    this.isSubtype(Predicate, supertype)
                );
            }
            case ConstraintUsage: {
                return (
                    this.isSubtype(BooleanExpression, supertype) ||
                    this.isSubtype(OccurrenceUsage, supertype)
                );
            }
            ...
            case Unioning: {
                return (
                    this.isSubtype(Relationship, supertype) ||
                    this.isSubtype(TypeRelationship, supertype)
                );
            }
            case Documentation: {
            ...
            case ExhibitStateUsage: {
                return (
                    this.isSubtype(PerformActionUsage, supertype) ||
                    this.isSubtype(StateUsage, supertype)
                );
            }
            case Expose:
            ...
            case FeatureInverting: {
                return (
                    this.isSubtype(FeatureRelationship, supertype) ||
                    this.isSubtype(Relationship, supertype)
                );
            }
            case FeatureMembership: {
                return (
                    this.isSubtype(Featuring, supertype) ||
                    this.isSubtype(OwningMembership, supertype)
                );
            }
            ...
            case NullExpression: {
                return (
                    this.isSubtype(Expression, supertype) ||
                    this.isSubtype(InlineExpression, supertype)
                );
            }
            case FeatureTyping:
            ...
            case FlowConnectionDefinition: {
                return (
                    this.isSubtype(ActionDefinition, supertype) ||
                    this.isSubtype(Interaction, supertype)
                );
            }
            case FlowConnectionUsage: {
                return (
                    this.isSubtype(ActionUsage, supertype) ||
                    this.isSubtype(ConnectorAsUsage, supertype) ||
                    this.isSubtype(ItemFlow, supertype)
                );
            }
            ...
            case IncludeUseCaseUsage: {
                return (
                    this.isSubtype(PerformActionUsage, supertype) ||
                    this.isSubtype(UseCaseUsage, supertype)
                );
            }
            case Interaction: {
                return (
                    this.isSubtype(Association, supertype) || this.isSubtype(Behavior, supertype)
                );
            }
            case Invariant: {
            ...
            case PortDefinition: {
                return (
                    this.isSubtype(OccurrenceDefinition, supertype) ||
                    this.isSubtype(Structure, supertype)
                );
            }
            case ItemFeature:
            case ItemFlowEnd:
            ...
            case LoopActionUsage: {
                return (
                    this.isSubtype(ActionUsage, supertype) ||
                    this.isSubtype(TransparentElement, supertype)
                );
            }
            case MembershipExpose: {
                return (
                    this.isSubtype(Expose, supertype) || this.isSubtype(MembershipImport, supertype)
                );
            }
            ...
            case MetadataDefinition: {
                return (
                    this.isSubtype(ItemDefinition, supertype) ||
                    this.isSubtype(Metaclass, supertype)
                );
            }
            case MetadataFeature: {
                return (
                    this.isSubtype(AnnotatingElement, supertype) ||
                    this.isSubtype(Feature, supertype)
                );
            }
            case MetadataUsage: {
                return (
                    this.isSubtype(ItemUsage, supertype) ||
                    this.isSubtype(MetadataFeature, supertype)
                );
            }
            ...
            case NamespaceExpose: {
                return (
                    this.isSubtype(Expose, supertype) || this.isSubtype(NamespaceImport, supertype)
                );
            }
            case NonOwnerType: {
            ...
            case OperatorExpression: {
                return (
                    this.isSubtype(InlineExpression, supertype) ||
                    this.isSubtype(InvocationExpression, supertype)
                );
            }
            ...
            case PerformActionUsage: {
                return (
                    this.isSubtype(ActionUsage, supertype) ||
                    this.isSubtype(EventOccurrenceUsage, supertype)
                );
            }
            ...
            case SatisfyRequirementUsage: {
                return (
                    this.isSubtype(AssertConstraintUsage, supertype) ||
                    this.isSubtype(RequirementUsage, supertype)
                );
            }
            ...
            case SuccessionAsUsage: {
                return (
                    this.isSubtype(ConnectorAsUsage, supertype) ||
                    this.isSubtype(Succession, supertype)
                );
            }
            case SuccessionFlowConnectionUsage: {
                return (
                    this.isSubtype(FlowConnectionUsage, supertype) ||
                    this.isSubtype(SuccessionItemFlow, supertype)
                );
            }
        ...
        switch (type) {
            case "ElementReference": {
                return {
                    ...
                    mandatory: [{ name: "parts", type: "array" }],
                };
            }
            case "AnnotatingElement": {
                return {
                    name: "AnnotatingElement",
                    mandatory: [{ name: "about", type: "array" }],
                };
            }
            case "Namespace": {
                return {
            ...
            case "Connector": {
                return {
                    name: "Connector",
                    mandatory: [{ name: "ends", type: "array" }],
                };
            }
            case "Dependency": {
                return {
            ...
            case "Membership": {
                return {
                    name: "Membership",
                    mandatory: [{ name: "isAlias", type: "boolean" }],
                };
            }
            case "LibraryPackage": {
                return {
                    name: "LibraryPackage",
                    mandatory: [{ name: "isStandard", type: "boolean" }],
                };
            }
            case "Feature": {
                return {
            ...
            case "FlowConnectionUsage": {
                return {
                    ...
                    mandatory: [{ name: "messages", type: "array" }],
                };
            }
            case "FeatureValue": {
                return {
            ...
            case "StateUsage": {
                return {
                    name: "StateUsage",
                    mandatory: [{ name: "isParallel", type: "boolean" }],
                };
            }
            case "InvocationExpression": {
                return {
                    name: "InvocationExpression",
                    mandatory: [{ name: "operands", type: "array" }],
                };
            }
            case "StateDefinition": {
                return {
            ...
            case "Invariant": {
                return {
                    name: "Invariant",
                    mandatory: [{ name: "isNegated", type: "boolean" }],
                };
            }
            case "LiteralBoolean": {
                return {
                    name: "LiteralBoolean",
                    mandatory: [{ name: "literal", type: "boolean" }],
                };
            }
            default: {
                return {
